...
namespace Fm.BLL{
	...
	{	     
		private readonly Fm.DAL.product_img dal = new Fm.DAL.product_img();
        ...
        /// </summary>
        public List<Fm.Entity.product_img> GetListCustomByXxx(string Xxx)
        {
        ...
        /// <param name="Xxx"></param>
        /// </summary>
        public List<Fm.Entity.product_img> GetListCustomByXxx(DBHelper myHelperMySQL, string Xxx)
        {
            List<Fm.Entity.product_img> myList = new List<Fm.Entity.product_img>();
