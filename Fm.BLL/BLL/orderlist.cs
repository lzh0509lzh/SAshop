...
namespace Fm.BLL{
	...
	{	     
		private readonly Fm.DAL.orderlist dal = new Fm.DAL.orderlist();
        ...
        /// </summary>
        public List<Fm.Entity.orderlist> GetListCustomByXxx(string Xxx)
        {
        ...
        /// <param name="Xxx"></param>
        /// </summary>
        public List<Fm.Entity.orderlist> GetListCustomByXxx(DBHelper myHelperMySQL, string Xxx)
        {
            List<Fm.Entity.orderlist> myList = new List<Fm.Entity.orderlist>();
