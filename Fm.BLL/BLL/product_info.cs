...
namespace Fm.BLL{
	...
	{	     
		private readonly Fm.DAL.product_info dal = new Fm.DAL.product_info();
        ...
        /// </summary>
        public List<Fm.Entity.product_info> GetListCustomByXxx(string Xxx)
        {
        ...
        /// <param name="Xxx"></param>
        /// </summary>
        public List<Fm.Entity.product_info> GetListCustomByXxx(DBHelper myHelperMySQL, string Xxx)
        {
            List<Fm.Entity.product_info> myList = new List<Fm.Entity.product_info>();
