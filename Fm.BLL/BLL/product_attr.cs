...
namespace Fm.BLL{
	...
	{	     
		private readonly Fm.DAL.product_attr dal = new Fm.DAL.product_attr();
        ...
        /// </summary>
        public List<Fm.Entity.product_attr> GetListCustomByXxx(string Xxx)
        {
        ...
        /// <param name="Xxx"></param>
        /// </summary>
        public List<Fm.Entity.product_attr> GetListCustomByXxx(DBHelper myHelperMySQL, string Xxx)
        {
            List<Fm.Entity.product_attr> myList = new List<Fm.Entity.product_attr>();
