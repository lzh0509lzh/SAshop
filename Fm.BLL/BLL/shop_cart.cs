...
namespace Fm.BLL{
	...
	{	     
		private readonly Fm.DAL.shop_cart dal = new Fm.DAL.shop_cart();
        ...
        /// </summary>
        public List<Fm.Entity.shop_cart> GetListCustomByXxx(string Xxx)
        {
        ...
        /// <param name="Xxx"></param>
        /// </summary>
        public List<Fm.Entity.shop_cart> GetListCustomByXxx(DBHelper myHelperMySQL, string Xxx)
        {
            List<Fm.Entity.shop_cart> myList = new List<Fm.Entity.shop_cart>();
