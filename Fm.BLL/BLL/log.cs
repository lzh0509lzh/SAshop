...
namespace Fm.BLL{
	...
	{	     
		private readonly Fm.DAL.log dal = new Fm.DAL.log();
        ...
        /// </summary>
        public List<Fm.Entity.log> GetListCustomByXxx(string Xxx)
        {
        ...
        /// <param name="Xxx"></param>
        /// </summary>
        public List<Fm.Entity.log> GetListCustomByXxx(DBHelper myHelperMySQL, string Xxx)
        {
            List<Fm.Entity.log> myList = new List<Fm.Entity.log>();
