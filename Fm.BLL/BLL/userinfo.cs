...
namespace Fm.BLL{
	...
	{	     
		private readonly Fm.DAL.userinfo dal = new Fm.DAL.userinfo();
        ...
        /// </summary>
        public List<Fm.Entity.userinfo> GetListCustomByXxx(string Xxx)
        {
        ...
        /// <param name="Xxx"></param>
        /// </summary>
        public List<Fm.Entity.userinfo> GetListCustomByXxx(DBHelper myHelperMySQL, string Xxx)
        {
            List<Fm.Entity.userinfo> myList = new List<Fm.Entity.userinfo>();
